        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                Route::get('/products/create', 'Webkul\Product\Http\Controllers\ProductController@create')->defaults('_config', [
                    'view' => 'shop::customers.account.products.create'
                ])->name('customer.account.products.create');

                Route::post('/products/create', 'Webkul\Product\Http\Controllers\ProductController@store')->defaults('_config', [
                    'redirect' => 'customers.account.products.edit'
                ])->name('customer.account.products.store');

                Route::get('/products/edit/{id}', 'Webkul\Product\Http\Controllers\ProductController@edit')->defaults('_config', [
                    'view' => 'shop::customers.account.products.edit'
                ])->name('customers.account.products.edit');

                Route::put('/products/edit/{id}', 'Webkul\Product\Http\Controllers\ProductController@update')->defaults('_config', [
                    'redirect' => 'customer.account.products.index'
                ])->name('customers.account.products.update');

//                Route::get('/products', 'Webkul\Product\Http\Controllers\ProductController@index')->defaults('_config', [
//                    'view' => 'shop::customers.account.products.index'
//                ])->name('customer.account.products.index');

//                OwnList
                        Route::get('/products', 'Webkul\Product\Http\Controllers\ProductController@OwnList')->defaults('_config', [
                            'view' => 'shop::customers.account.products.ownlist'
                        ])->name('customer.account.products.index');
