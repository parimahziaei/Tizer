...
@push('scripts')
    ...
    <script type="text/x-template" id="variant-form-template">
        <form method="POST" action="{{ route('customer.account.products.store') }}" data-vv-scope="add-variant-form" @submit.prevent="addVariant('add-variant-form')">
    ...
    <script type="text/x-template" id="variant-item-template">
        <tr>
            ...
            <td class="actions">
                <a :href="['{{ route('customer.account.products.index') }}/edit/' + variant.id]"><i class="icon pencil-lg-icon"></i></a>
